    ...
    connectedCallback() 
    {
        ...
        `
            <div id="Contacts">
                ...
                <a href="https://www.linkedin.com/in/elagmae"><img src="Resources/LinkedinLogo.png" class="ContactLogos"></a>
                <a href="https://elagmae.itch.io"><img src="Resources/ItchioLogo.png" class="ContactLogos" style="filter: brightness(0) invert(1);"></a>
            </div>
            `;
    }
}
