class Contacts extends HTMLElement 
{
    connectedCallback() 
    {
        ...
        `
            <div id="Contacts">
                <a href="https://www.instagram.com/elagmae"><img src="../Resources/Sources/InstagramLogo.png" alt="Instagram" class="ContactLogos" style="filter: brightness(0) invert(1);"></a>
